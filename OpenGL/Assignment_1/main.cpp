...
int main() 
{
    ...
    // ------------------------------------
    Shader lightingShader("09_Basic_Lighting/color.vs", "09_Basic_Lighting/color.fs");
    Shader lightCubeShader("09_Basic_Lighting/light_cube.vs", "09_Basic_Lighting/light_cube.fs");
