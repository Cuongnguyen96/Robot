...
int main() 
{
    ...
    // ------------------------------------
    Shader lightingShader("13_Multiple_lights/color.vs", "13_Multiple_lights/color.fs");
    Shader lightCubeShader("13_Multiple_lights/light_cube.vs", "13_Multiple_lights/light_cube.fs");
